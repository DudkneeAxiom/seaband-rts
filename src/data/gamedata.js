...
export const PORTS = [
  {
    ...
    desc:'Three streets, eleven taverns, and a harbourmaster who has never once asked where cargo came from.',
    services:['repair','market','crew','shipyard','tavern'],
    prices:{ fish:0.78, timber:0.95, iron:1.15, cloth:1.05, spice:1.25 },
  },
  {
    id:'marasay', name:'Marasay', faction:'freehold', island:'marasay',
    x: 640, z: 862, ang: -2.2, dockR: 74, size:'minor',
    tagline:'Fishing hamlet',
    desc:'Drying racks, a chapel, and one crane the whole village argues about.',
    services:['repair','market','crew'],
    prices:{ fish:0.55, timber:1.10, iron:1.30, cloth:1.15, spice:1.35 },
  },
  {
    ...
    desc:'A gun-cut rock with a signal mast. The Admiralty pays well for pirates and asks for receipts.',
    services:['repair','market','tavern'],
    prices:{ fish:1.20, timber:1.25, iron:0.72, cloth:0.85, spice:1.10 },
  },
];
